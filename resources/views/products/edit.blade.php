...
<div class="mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb" style="background: transparent; padding: 0;">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('productos.show', $product) }}" class="text-decoration-none" style="color: #6366f1;">
    ...
    <h1 class="page-title">
        <i class="bi bi-pencil-square me-2" style="color: var(--primary);"></i>Editar Producto
    </h1>
</div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header px-4 py-3">
                <span class="fw-semibold"><i class="bi bi-pencil me-2"></i>Modificar información</span>
            </div>
            <div class="card-body p-4">
                <form method="POST" action="{{ route('productos.update', $product) }}">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <a href="{{ route('productos.show', $product) }}" class="btn btn-outline-light px-4">
                            Cancelar
                        </a>
                    </div>
                </form>
